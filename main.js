...
let words = ["STAN", "FREEBRITNEY","RELATABLE","FINNA","ZADDY","DOWNBAD", "IYKYK","MOOD", "KING","QUEEN","TOXIC", "CRINGE", "SIMP", "SHEEEESH", "BUSSIN", "SNATCHED", "CLAPBACK", "SKRRT", "PERIODT", "FLEX", "SUS", "SHOOK", "RECIEPTS", "SLAPS", "SHADE", "EXTRA", "GUCCI", "LIT", "RATCHET", "SAVAGE", "THIRSTY", "UNALIVE", "STORYTIME", "USSY", "BRUH","STUDIOUS", "NEUROTYPICALS", "WOMBLANDS", "GRWM", "CHUBBABUN", "THICC"]
